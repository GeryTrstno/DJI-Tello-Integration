...
def get_joystick_input():
    ...
    if state.toggle_joystick == True:
        try:
            ...
            if state.joystick.get_button(2):  # Alternative screenshot button
                request_manual_screenshot("joystick")
                time.sleep(0.2)

            # Handle recording button (Button 4 / Y button)
            current_recording_button_state = state.joystick.get_button(3)
            ...
            if state.joystick.get_button(4): 
            ...
            if state.joystick.get_button(5):
            ...
            current_detection_toggle_button_state = state.joystick.get_button(6)
            ...
            if state.joystick.get_button(7):  # Button 9 - toggle joystick
            ...
            if state.joystick.get_button(8): # Button 10 - toggle joystick control
                if state.joystick_mode == True:
            ...
            current_emergency_button_state = state.joystick.get_button(9)
